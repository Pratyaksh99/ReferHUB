...
public class AddCoupon extends Activity {
    ...
    protected void addCoupon(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AddCoupon.this, android.R.layout.simple_spinner_item, brands);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("Coupon").push().setValue(new_Coupon);
            }
        });
    }
}
